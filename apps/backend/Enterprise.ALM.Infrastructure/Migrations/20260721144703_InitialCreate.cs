        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostPerSeat = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Full system authorization & rule control.", "Admin" },
                    { 2, "Read/Write assets, licenses, and seats.", "Manager" },
                    { 3, "Read-only access to monitoring dashboards.", "Viewer" }
                });
